  ...
  Widget build(BuildContext context) {
    ...
    return PlatformScaffold(
      appBar: PlatformAppBar(
        title: Text('FeedBack Settings', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 18, color: PsColors.black, fontFamily: 'Montserrat'),),
                            ...
                            child: Card(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Text('Receive and show feedback',style: TextStyle(fontWeight: FontWeight.normal, fontSize: 15, color: PsColors.black, fontFamily: 'Montserrat')),
                                        ),
                                        PlatformSwitch(
                                            onChanged: (bool value) async {
                                              ...
                                              if (await Utils.checkInternetConnectivity()) {
                                                ...
                                                final DrResource<UserModel> _apiStatus = await userProvider.postFeedBackUpdate(
                                                  {
                                                    "receive_feedback": _value.toString(),
                                                  },
                                    ...
                                    Container(
                                      margin: EdgeInsets.only(top: 5,right: 14, left: 14),
                                      child: Text('Disabling feedback is available only for sellers with VIP and VIP+ subscription',style: TextStyle(fontWeight: FontWeight.normal, fontSize: 14, color: Colors.black54, fontFamily: 'Montserrat')),
                                    ),
                                    SizedBox(height: 30,)
                                  ],
                                )
